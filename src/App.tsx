...
const AVAILABLE_COMPONENTS = ["badge", "button", "button-group", "popover", "animate-number", "area-chart", "divider", "datepicker", "table", "card", "input", "icon-button", "skeleton", "tabs", "sidebar", "modal", "drawer", "float-action-menu", "tooltip", "dock", "slider"];
