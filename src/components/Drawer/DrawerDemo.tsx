      ...
      >
        <div className="flex flex-col gap-6 py-4">
          <div className="space-y-4">
            <h4 className="text-xs font-bold text-neutral-400 uppercase tracking-widest">General</h4>
            <div className="grid gap-2">
              <button className="flex items-center gap-3 w-full p-2.5 rounded-xl transition-all hover:bg-neutral-50 dark:hover:bg-neutral-900 border border-transparent hover:border-neutral-200 dark:hover:border-neutral-800 group text-sm font-medium text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white">
          ...
          <div className="space-y-4">
            <h4 className="text-xs font-bold text-neutral-400 uppercase tracking-widest">Logs</h4>
            <div className="flex flex-col gap-4 border-l-2 border-neutral-100 dark:border-neutral-900 ml-2 pl-6 py-2">
              {[
                ...
                <div key={i} className="relative">
                  <div className={cn(
                    "absolute -left-[31px] top-1 size-2.5 rounded-full border-2 border-white dark:border-neutral-950 shadow-sm",
                    log.active ? "bg-emerald-500" : "bg-neutral-300 dark:bg-neutral-800"
                  )} />
                  <p className="text-sm font-medium text-neutral-800 dark:text-neutral-200">{log.label}</p>
          ...
          <div className="p-4 rounded-2xl bg-neutral-900 text-white flex items-center justify-between">
            ...
            <FiActivity className="size-8 text-neutral-700" />
          </div>
