  ...
  return (
    ...
    >
      ...
      {showTooltip && hoveredIndex !== null && (
        <div
          className={cn(
            "absolute z-50 pointer-events-none transform -translate-x-1/2 bg-ds-950 text-white ds-rounded shadow-2xl border border-ds-800 p-3 flex flex-col gap-2 min-w-[140px] transition-transform duration-200",
