  ...
  return (
    <div className="flex flex-col gap-16 w-full">
      ...
      <div className="flex flex-col gap-6">
        <h3 className="text-sm font-bold text-base-500 uppercase tracking-widest px-4 md:px-0">Style Variants</h3>
      ...
      {/* Rounded Styles */}
      <div className="flex flex-col gap-6">
        <h3 className="text-sm font-bold text-base-500 uppercase tracking-widest px-4 md:px-0">Shape Options</h3>
        <div className="flex items-center gap-12 flex-wrap">
          <div className="flex flex-col gap-4 items-center">
            <IconButton icon={<FiTrash size={20} />} variant="soft" rounded={false} />
            <span className="text-[10px] uppercase font-bold text-base-400 tracking-wider">Default (MD)</span>
          </div>
          <div className="flex flex-col gap-4 items-center">
            <IconButton icon={<FiTrash size={20} />} variant="soft" rounded={true} />
            <span className="text-[10px] uppercase font-bold text-base-400 tracking-wider">Full Circular</span>
          </div>
        </div>
      </div>
    </div>
