        ...
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
          <div className="flex items-center gap-6 text-[13px] md:text-sm">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="font-medium text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-white transition-colors"
            >
              GitHub
            </a>
            <Link
          ...
          <span className="hidden md:block text-xs text-neutral-300 dark:text-neutral-700 select-none">|</span>
          <p className="text-[12px] md:text-sm text-neutral-400 dark:text-neutral-500">
